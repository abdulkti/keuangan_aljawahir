<?php
  $pageTitle = 'Rekap THT';
  $pageDesc = 'Rekap Tabungan Hari Tua seluruh guru';
?>
<?= view('layout/header') ?>
<div class="app-shell">
  ...
  <div class="main-area">
    ...
    <div class="content">
      ...
      <div class="ku-toolbar">
        <form method="GET" action="/rekap/tht" class="ku-toolbar-left" style="display:flex;gap:8px;flex-wrap:wrap;margin:0">
        ...
        <div class="ku-toolbar-right">
          <a href="/rekap/tht?export=tht&tahun_ajaran=<?= $tahunAjaran ?>&bulan=<?= $bulanTerpilih ?>" class="ku-btn ku-btn-primary">
      ...
      <div class="ku-stats">
        <div class="ku-stat ku-stat-green" style="--delay:0s">
          ...
          <div class="ku-stat-body">
            ...
            <div class="ku-stat-value">Rp <?= number_format(array_sum(array_column($rekapTahun, 'total_setoran')), 0, ',', '.') ?></div>
          </div>
        </div>
        <div class="ku-stat ku-stat-red" style="--delay:0.1s">
          ...
          <div class="ku-stat-body">
            <div class="ku-stat-label">Total Realisasi</div>
            <div class="ku-stat-value">Rp <?= number_format(array_sum(array_column($rekapTahun, 'total_penarikan')), 0, ',', '.') ?></div>
          </div>
        </div>
        <div class="ku-stat ku-stat-indigo" style="--delay:0.2s">
          ...
          <div class="ku-stat-body">
            ...
            <div class="ku-stat-value">Rp <?= number_format($grandTotalTHT, 0, ',', '.') ?></div>
